...
function carawebs_project_slider() {
  ...
  if(!empty($slider_images) ){ // run if the repeater field has content
    ...
    //if (carawebs_is_phone()=='false'){// if this is a mobile phone, don't build a slider
      if ($is_phone == 'true'){
...
function carawebs_enqueue_project_scripts () {
    ...
    wp_register_script( 'project-page-script', THESIS_USER_SKIN_URL . '/js/project-page.js', array( 'jquery' ), null, true);
    ...
    if( !empty($extra)) {
      ...
      $second_content = 'false';
		...
		// Define the variable in js like this: var extraContent = (carawebsProjectVars.secondContent);
...
function carawebs_enqueue_slider () {
    ...
    wp_register_script( 'ios_slider', get_template_directory_uri() . '/assets/scripts/jquery.iosslider.js', array( 'jquery' ), null, false);
		wp_register_script( 'ios_slider_control', get_template_directory_uri() . '/assets/scripts/ios-slider-control.js', array( 'jquery' ), null, true);
